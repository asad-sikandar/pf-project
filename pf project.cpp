...
void showMenu(); void cgpaSystem();void attendanceSystem();
void librarySystem();void addStudent();void viewStudents();void saveStudents();void addAttendance();
void viewAttendance();void saveAttendance();void addBook();void viewBooks();
void saveBooks();
int main() {
    int choice;
    do {
